...
import { AuthType, type Config } from '@termon/core';
...
import { clearCachedCredentialFile } from '@termon/core';
import { Text } from 'ink';

// Mocks
vi.mock('@termon/core', async (importOriginal) => {
  const actual =
    await importOriginal<typeof import('@termon/core')>();
  return {
    ...actual,
